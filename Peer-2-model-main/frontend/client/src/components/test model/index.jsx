...
// Station credentials
const senderAddress = "0x98853b07AcF7D832969d43c88AC81E94ED66259e";
const senderPrivateKey = "0xdebb448f0196ee3e2e0219d68e2862fa5e4b612fe6c64d918e787ff959ec2309";


function Index() {
  const { state: { contract, accounts } } = useEth();
  const [value, setValue] = useState("?");
  const [station1, setStation1] = useState("0x98853b07AcF7D832969d43c88AC81E94ED66259e");
  const [station2, setStation2] = useState("0x98853b07AcF7D832969d43c88AC81E94ED66259e");
...
const startTransfer = async () =>{
  ...
  const message = parseInt(positives[i]*1000);
  ...
  const functionSignature = contract.methods.write(message).encodeABI(); 
